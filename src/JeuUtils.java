 ...
 * navale. INF2120 E17 : classe fournie avec l'enonce du TP3.
 *
 * @author melanie Lord
 * @version 02/07/2017
 */
public class JeuUtils {
   ...
   /**
    * Retourne  une chaine de 64 caracteres representant une grille 
   ...
   /**
    * Affiche la chaine donnee à la console, sous forme d'une grille de dimensions 
    * NBR_LIGNES_OU_COL_GRILLE X NBR_LIGNES_OU_COL_GRILLE dans laquelle chaque 
    * caractere de la chaine donne est dans une case de la grille.
    * 
    * POUR TESTS SEULEMENT : Permet de visualiser la grille solution à la console 
    * pour vous aider a deboguer votre application graphique.
    * 
